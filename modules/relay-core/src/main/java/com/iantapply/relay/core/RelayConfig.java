...
public record RelayConfig(
    ...
    public enum NodeRole {
        ...
        public String channelName() { return name().toLowerCase(Locale.ROOT); }
    }
    ...
    public RelayConfig {
        ...
        if (!NAMESPACE.matcher(namespace).matches()) throw new IllegalArgumentException("Invalid Redis namespace: " + namespace);
        ...
        if (maximumMessageAge.isNegative()) throw new IllegalArgumentException("maximumMessageAge must not be negative");
    }
}
